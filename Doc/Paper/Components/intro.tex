...
\begin{figure}[H]
    \centering
    \includegraphics[width=\columnwidth]{media/design/2026-04-27-08-26-08.png}
    \captionof{figure}{Imagen referencial del concepto de Ant Colony Optimization (ACO) \cite{dorigo2004ant}}
...
Un desafío crítico en la aplicación del ACO estándar es el riesgo de "inanición" de datos para clientes con ciclos de vida largos, típicamente de 9 a 12 meses. En un modelo convencional, el rastro de feromona se evaporaría por completo mucho antes de que el cliente requiera un nuevo servicio, causando que el sistema ignore oportunidades valiosas. Para mitigar esto, se ha perfeccionado el algoritmo mediante un mecanismo de Feromona de Activación Retardada, el cual sustituye la evaporación lineal constante por una programación basada en el historial de desembolsos previos. Bajo este enfoque, cuando el sistema identifica un perfil de "Recurrente Estacional", la tasa de evaporación ($\rho$) se reduce drásticamente durante el periodo de inactividad, manteniendo el rastro en un estado "latente" que preserva la relevancia del cliente en la base de conocimiento del enjambre.La operatividad de esta mejora se centra en la Re-inyección Automática de Feromona. Utilizando el patrón de recurrencia identificado, el sistema inyecta automáticamente una carga de feromona de alta intensidad aproximadamente 30 días antes de que se cumpla el ciclo previsto de 12 meses. Esta priorización predictiva garantiza que, a pesar de la ausencia de actividad reciente, el cliente emerja en la cima de la lista de tareas del ejecutivo justo en el momento de mayor probabilidad de necesidad financiera. De esta manera, el sistema trasciende el simple recordatorio manual para convertirse en un motor de inteligencia comercial que anticipa la demanda antes de que el cliente busque otras alternativas en el mercado.

Finalmente, esta optimización impacta profundamente en la analítica gerencial, transformando todo lo anterior propuesto en una herramienta avanzada de planeación de demanda. El gerente puede visualizar "olas" de feromonas que se activarán en meses futuros, lo que facilita una gestión proactiva de la liquidez necesaria para cubrir dichos desembolsos. Al sincronizar el comportamiento de los agentes con los ciclos naturales del capital de los clientes, la institución logra una eficiencia operativa superior, asegurando que la fuerza de ventas actúe con precisión en el momento exacto en que la probabilidad de conversión es máxima.